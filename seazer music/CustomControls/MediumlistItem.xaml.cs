...
{
    public sealed partial class MediumlistItem : UserControl
    {
        public MediumlistItem()
        {
            InitializeComponent();
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(MediumlistItem), new PropertyMetadata(string.Empty));

        public IEnumerable<MediumList>    Items
        {
            get => (IEnumerable<MediumList>)GetValue(ItemsProperty);
            set => SetValue(ItemsProperty, value);
        }

        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register(nameof(Items), typeof(IEnumerable<MediumList>), typeof(MediumlistItem), new PropertyMetadata(null));
