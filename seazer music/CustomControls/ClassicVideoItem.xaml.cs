...
{
    public sealed partial class ClassicVideoItem : UserControl
    {
        public ClassicVideoItem()
        {
            InitializeComponent();

            // ViewChanged olayýný dinle
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(ClassicVideoItem), new PropertyMetadata(string.Empty));

        public IEnumerable<VideoList> Items
        {
            get => (IEnumerable<VideoList>)GetValue(ItemsProperty);
            set => SetValue(ItemsProperty, value);
        }

        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register(nameof(Items), typeof(IEnumerable<VideoList>), typeof(ClassicVideoItem), new PropertyMetadata(null));
