...
{
    public sealed partial class BasicListItem : UserControl
    {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(BasicListItem), new PropertyMetadata(string.Empty));

        public IEnumerable<BasicList> Items
        {
            get => (IEnumerable<BasicList>)GetValue(ItemsProperty);
            set => SetValue(ItemsProperty, value);
        }

        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register(nameof(Items), typeof(IEnumerable<BasicList>), typeof(BasicListItem), new PropertyMetadata(null));
